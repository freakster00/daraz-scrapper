...
Production-ready Flask application for the Daraz scraper API.
Optimized for Gunicorn deployment with proper error handling and logging.
"""
...
def create_app() -> Flask:
    ...
    def index():
        ...
        return (
            "<h1>Daraz Scraper API - Production</h1>"
    ...
    def test_endpoint():
        ...
        return jsonify({
            "status": "success",
            "message": "Daraz Scraper API (Production) is working!",
